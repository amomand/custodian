...
class PlaytestReport:
    ...
    def summary_lines(self) -> tuple[str, ...]:
        ...
        return (
            ...
            f"manual familiarity: {_manual_familiarity_label(self.final_state)}",
...
SCENARIOS: dict[str, Scenario] = {
    ...
    "practised-manual": Scenario(
        ...
        description="Build hand familiarity early, then survive the pressure beats.",
        commands=(
            "balance",
            "flush",
            "pump up",
    ...
    "raw-curious": Scenario(
        name="raw-curious",
        description="Check raw telemetry repeatedly while mixing manual work and delegation.",
        commands=(
